...
function Grundlagen() {
  ...
  const moduleData = [
    ...
    // PRACTICE #1
    {
      ...
      description:
        "Vertiefe dein Verständnis über die griechischen Buchstaben.",
    ...
    // THEORY #2
    {
      ...
      description:
        "Lerne die Lateinische Buchstaben, die in der Mathematik vorkommen.",
    ...
    // PRACTICE #2
    {
      ...
      description:
        "Vertiefe dein Verständnis über die lateinischen Buchstaben.",
    ...
    // THEORY #4
    {
      ...
      description:
        "Erfahre mehr über Zahlenmengen und grundlegende Rechenregeln.",
    ...
    // THEORY #7
    {
      ...
      description:
        "Wie verknüpft man Addition und Multiplikation? Das Distributivgesetz!",
    ...
    // THEORY #10
    {
      ...
      description:
        "Lerne, wie du mithilfe des Siebs von Eratosthenes Primzahlen findest.",
    ...
    {
      id: 23,
      title: "Ganze Zahlen Addition",
      headline: "Ganze Zahlen Addition",
      route: "/theory/ganzeZahlenAddition",
    },
  ];
